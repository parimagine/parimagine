...
public class Photo implements Comparable<Photo> {
    ...
    static public final Comparator<Photo> comparator = new ComparatorPourri();
    static public final Comparator<String> naturalOrderComparator = new NaturalOrderComparator(); 
